...
@implementation AlivcGuidePageView
...
- (void)setupSubViews {
    ...
    leftLabel.text = NSLocalizedString(@"slide_right_view_log_char", nil);
    ...
    rightLabel.text = NSLocalizedString(@"slide_left_view_log", nil);
